...
import com.justifiedsolutions.openpdf.pdf.RunningMarginal;

public class HeaderFooter extends Rectangle {

    private final RunningMarginal runningMarginal;
    private int pageNumber;

    public HeaderFooter(RunningMarginal runningMarginal) {
        super(0, 0, 0, 0);
        this.runningMarginal = runningMarginal;
    }
