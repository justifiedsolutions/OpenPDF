...
package com.justifiedsolutions.openpdf.text.html.simpleparser;

import static com.justifiedsolutions.openpdf.text.html.Markup.parseLength;
...
import com.justifiedsolutions.openpdf.text.ElementTags;
import com.justifiedsolutions.openpdf.text.ExceptionConverter;
import com.justifiedsolutions.openpdf.text.FontProvider;
...
import com.justifiedsolutions.openpdf.text.html.HtmlTags;
...
import com.justifiedsolutions.openpdf.text.pdf.draw.LineSeparator;
import com.justifiedsolutions.openpdf.text.utils.NumberUtilities;
...
public class HTMLWorker implements SimpleXMLDocHandler, DocListener {
    ...
    private final ChainedProperties cprops = new ChainedProperties();
    ...
    private final Stack<Object> tableState = new Stack<>();
    private boolean skipText = false;
    private Map<String, Object> interfaceProps;
    private final FactoryProperties factoryProperties = new FactoryProperties();
    ...
    public void startElement(String tag, Map<String, String> style) {
        ...
        try {
            ...
            if (tag.equals(HtmlTags.HORIZONTALRULE)) {
                ...
                currentParagraph.add(new LineSeparator(hrSize, hrWidth, null, hrAlign,
            ...
            if (tag.equals(HtmlTags.UNORDEREDLIST)) {
                ...
                skipText = true;
                cprops.addToChain(tag, style);
                com.justifiedsolutions.openpdf.text.List list = new com.justifiedsolutions.openpdf.text.List(false);
                try {
            ...
            if (tag.equals(HtmlTags.ORDEREDLIST)) {
                ...
                skipText = true;
                cprops.addToChain(tag, style);
                com.justifiedsolutions.openpdf.text.List list = new com.justifiedsolutions.openpdf.text.List(true);
                try {
                    list.setIndentationLeft(Float.parseFloat(cprops.getProperty("indent")));
                } catch (Exception e) {
                    list.setAutoindent(true);
    ...
    public void endElement(String tag) {
        ...
        try {
            ...
            if (tag.equals(HtmlTags.UNORDEREDLIST)
                ...
                Object obj = stack.pop();
                if (!(obj instanceof com.justifiedsolutions.openpdf.text.List)) {
                    stack.push(obj);
                    return;
                }
                if (stack.empty()) {
                    ...
                    if (peek instanceof com.justifiedsolutions.openpdf.text.List) {
                        ((com.justifiedsolutions.openpdf.text.List) peek).add((com.justifiedsolutions.openpdf.text.List) obj);
                    } else {
            ...
            if (tag.equals(HtmlTags.LISTITEM)) {
                ...
                if (!(list instanceof com.justifiedsolutions.openpdf.text.List)) {
                    stack.push(list);
                    return;
                }
                ListItem item = (ListItem) obj;
                ((com.justifiedsolutions.openpdf.text.List) list).add(item);
