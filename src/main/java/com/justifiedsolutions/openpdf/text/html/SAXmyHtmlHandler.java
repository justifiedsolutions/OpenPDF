...
import com.justifiedsolutions.openpdf.text.xml.SAXiTextHandler;
...
public class SAXmyHtmlHandler extends SAXiTextHandler<HtmlPeer> // SAXmyHandler
{
    ...
    /**
     * Constructs a new SAXiTextHandler that will translate all the events triggered by the parser
     * to actions on the <CODE>Document</CODE>-object.
     *
