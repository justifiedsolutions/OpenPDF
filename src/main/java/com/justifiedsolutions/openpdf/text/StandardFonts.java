...
public enum StandardFonts {
    ...
    LIBERATION_MONO(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationMono-Regular.ttf"),
    LIBERATION_MONO_ITALIC(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationMono-Italic.ttf"),
    LIBERATION_MONO_BOLD(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationMono-Bold.ttf"),
    LIBERATION_MONO_BOLDITALIC(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationMono-BoldItalic.ttf"),
    // Helvetica
    ...
    LIBERATION_SANS(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationSans-Regular.ttf"),
    LIBERATION_SANS_ITALIC(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationSans-Italic.ttf"),
    LIBERATION_SANS_BOLD(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationSans-Bold.ttf"),
    LIBERATION_SANS_BOLDITALIC(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationSans-BoldItalic.ttf"),
    // Times
    ...
    LIBERATION_SERIF(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationSerif-Regular.ttf"),
    LIBERATION_SERIF_ITALIC(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationSerif-Italic.ttf"),
    LIBERATION_SERIF_BOLD(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationSerif-Bold.ttf"),
    LIBERATION_SERIF_BOLDITALIC(
            "com/justifiedsolutions/openpdf/text/pdf/fonts/liberation/LiberationSerif-BoldItalic.ttf"),
    // Others
