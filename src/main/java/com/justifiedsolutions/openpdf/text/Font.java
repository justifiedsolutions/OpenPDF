 ...
 * <PRE>
 * <p>
 * Paragraph p = new Paragraph("This is a paragraph", <STRONG>new Font(Font.HELVETICA, 18,
 * Font.BOLDITALIC, new Color(0, 0, 255)) </STRONG>);
 *
 * </PRE>
 *
 * </BLOCKQUOTE>
...
public class Font implements Comparable {
    ...
    /**
     * Translates a <CODE>String</CODE> -value of a certain family into the index that is used for
     * this family in this class.
     *
    ...
    /**
     * Sets the family using a <CODE>String</CODE> ("Courier", "Helvetica", "Times New Roman",
    ...
    /**
     * Gets the <CODE>BaseFont</CODE> this class represents. For the built-in fonts a
     * <CODE>BaseFont</CODE> is calculated.
     *
