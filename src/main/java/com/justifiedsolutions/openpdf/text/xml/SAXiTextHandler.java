...
package com.justifiedsolutions.openpdf.text.xml;
...
import com.justifiedsolutions.openpdf.text.factories.ElementFactory;
import com.justifiedsolutions.openpdf.text.pdf.BaseFont;
import com.justifiedsolutions.openpdf.text.pdf.draw.LineSeparator;
import com.justifiedsolutions.openpdf.text.xml.simpleparser.EntitiesToSymbol;
...
public class SAXiTextHandler<T extends XmlPeer> extends DefaultHandler {
    ...
    public void handleEndingTags(String name) {
        ...
        try {
            ...
            if (ElementTags.PHRASE.equals(name) || ElementTags.ANCHOR.equals(name)
                    || ElementTags.LIST.equals(name)
            ...
            if (ElementTags.ROW.equals(name)) {
                ...
                for (Cell value : cells) {
                    ...
                    if (cell.getWidth() == 0) {
                        ...
                        try {
                            cellWidths[j] = Float
                                    .parseFloat(width.substring(0, width.length() - 1) + "f");
                            total += cellWidths[j];
                            cellNulls[j] = false;
                        } catch (Exception e) {
                            // empty on purpose
