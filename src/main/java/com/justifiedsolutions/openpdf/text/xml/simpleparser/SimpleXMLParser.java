 ...
 *
 */
package com.justifiedsolutions.openpdf.text.xml.simpleparser;
...
public final class SimpleXMLParser {
     ...
     */
    private SimpleXMLParser(SimpleXMLDocHandler doc, SimpleXMLDocHandlerComment comment,
            boolean html) {
        this.doc = doc;
     ...
     */
    public static void parse(SimpleXMLDocHandler doc, SimpleXMLDocHandlerComment comment, Reader r,
    ...
    /**
     * Parses the XML document firing the events to the handler. Assumes UTF-8.
     *
     * @param doc the document handler
    ...
    public static void parse(SimpleXMLDocHandler doc, InputStream in) throws IOException {
        parse(doc, new InputStreamReader(in, StandardCharsets.UTF_8));
    }
    ...
    private void go(Reader r) throws IOException {
        ...
        while (true) {
            ...
            switch (state) {
                ...
                case SINGLE_TAG:
                    if (character != '>') {
                        throwException(MessageLocalization
                                .getComposedMessage("expected.gt.for.tag.lt.1.gt", tag));
                    }
                    doTag();
                    processTag(true);
                    processTag(false);
                ...
                case QUOTE:
                    if (html && quoteCharacter == ' ' && character == '>') {
                        ...
                        initTag();
                        state = restoreState();
                    } else if (html && quoteCharacter == ' ' && Character
                ...
                case ATTRIBUTE_EQUAL:
                    if (character == '=') {
                        ...
                        throwException(MessageLocalization
                                .getComposedMessage("error.in.attribute.processing"));
                    }
                    break;
    ...
    private void throwException(String s) throws IOException {
        throw new IOException(MessageLocalization
                .getComposedMessage("1.near.line.2.column.3", s, String.valueOf(lines),
