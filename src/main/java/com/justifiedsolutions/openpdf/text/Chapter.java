 ...
 * FontFactory.getFont(FontFactory.HELVETICA, 16, Font.BOLD, new Color(255, 0, 0))); Section
 * section1 = <STRONG>chapter2.addSection(title21);</STRONG> Paragraph someSectionText = new
 * Paragraph("This is some silly paragraph in a chapter and/or section. It contains some text to
...
public class Chapter extends Section {
    ...
    public static Chapter getInstance(com.justifiedsolutions.openpdf.pdf.Chapter chapter) {
        ...
        Paragraph title = Paragraph.getInstance(chapter.getTitle());
        Chapter result = new Chapter(title, chapter.getSectionNumber());
        processSection(result, chapter);
        return result;
    }
