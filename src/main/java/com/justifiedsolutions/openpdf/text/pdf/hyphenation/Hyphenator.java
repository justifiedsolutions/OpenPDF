...
package com.justifiedsolutions.openpdf.text.pdf.hyphenation;
...
public class Hyphenator {
    ...
    private static final String defaultHyphLocation = "com/justifiedsolutions/openpdf/text/pdf/hyphenation/hyph/";
