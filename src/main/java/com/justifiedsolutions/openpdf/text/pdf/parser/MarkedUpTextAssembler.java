/*
 * Copyright 2014 by Tizra Inc. The contents of this file are subject to the Mozilla Public License
 * Version 1.1 (the "License"); you may not use this file except in compliance with the License. You
 ...
 * <p>
 * The Initial Developer of the Original Code is Bruno Lowagie. Portions created by the Initial
 * Developer are Copyright (C) 1999-2008 by Bruno Lowagie. All Rights Reserved. Co-Developer of the
 * code is Paulo Soares. Portions created by the Co-Developer are Copyright (C) 2000-2008 by Paulo
 * Soares. All Rights Reserved.
 * <p>
 * Contributor(s): all the names of the contributors are added in the source code where applicable.
 * <p>
 * Alternatively, the contents of this file may be used under the terms of the LGPL license (the
...
public class MarkedUpTextAssembler implements TextAssembler {
     ...
     */
    private final List<TextAssemblyBuffer> partialWords = new ArrayList<>();
    ...
    /**
     * {@inheritDoc}
     * @see TextAssembler#process(Word, String)
     */
    @Override
    ...
    /**
     * {@inheritDoc}
     * @see TextAssembler#endParsingContext(String)
     */
    @Override
    ...
    public void renderText(ParsedTextImpl partialWord) {
        ...
        } else if (spacing < partialWord.getSingleSpaceWidth() / 2.3 || inProgress
                .shouldNotSplit()) {
