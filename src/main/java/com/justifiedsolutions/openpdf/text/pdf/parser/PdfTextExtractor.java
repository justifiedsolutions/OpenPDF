...
import com.justifiedsolutions.openpdf.text.pdf.RandomAccessFileOrArray;
...
public class PdfTextExtractor {
     ...
     *
     * @param reader         the reader with the PDF
     * @param renderListener the render listener that will be used to analyze renderText operations
     *                       and provide resultant text
     */
        ...
        switch (contentObject.type()) {
            ...
            default:
                throw new IllegalStateException(
                        "Unable to handle Content of type " + contentObject.getClass());
        }
        return result;
    }
     ...
     * @param useContainerMarkup should we put tags in for PDf markup container elements (not really
     *                           HTML at the moment).
     ...
     * @param handler      interprets events caused by recognition of operations in a content
     *                     stream.
     */
