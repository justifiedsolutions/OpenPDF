...
import com.justifiedsolutions.openpdf.text.pdf.internal.PolylineShape;
...
*/
    ...
    private boolean drawImage(Image img, Image mask, AffineTransform xform, Color bgColor, ImageObserver obs) {
        ...
        try {
            com.justifiedsolutions.openpdf.text.Image image = null;
            if(!convertImagesToJPEG){
                image = com.justifiedsolutions.openpdf.text.Image.getInstance(img, bgColor);
            }
            else{
                ...
                scaled.flush();
                scaled = null;
                image = com.justifiedsolutions.openpdf.text.Image.getInstance(baos.toByteArray());
                
            }
            if (mask!=null) {
                com.justifiedsolutions.openpdf.text.Image msk = com.justifiedsolutions.openpdf.text.Image
                        .getInstance(mask, null, true);
                msk.makeMask();
    ...
    private void setPaint(boolean invert, double xoffset, double yoffset, boolean fill) {
        if (paint instanceof Color) {
            ...
            try {
                ...
                com.justifiedsolutions.openpdf.text.Image image = com.justifiedsolutions.openpdf.text.Image
                        .getInstance(img, null);
