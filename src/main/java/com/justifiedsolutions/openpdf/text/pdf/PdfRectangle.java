 ...
 * <p>
 * Rectangles are used to describe locations on the page and bounding boxes for several objects in
 * PDF, such as fonts. A rectangle is represented as an <CODE>array</CODE> of four numbers,
 * specifying the lower left <I>x</I>, lower left <I>y</I>, upper right <I>x</I>, and upper right
 * <I>y</I> coordinates of the rectangle, in that order.<BR> This object is described in the
 * 'Portable Document Format Reference Manual version 1.3' section 7.1 (page 183).
 */
public class PdfRectangle extends PdfArray {
    ...
    /**
     * Overrides the <CODE>add</CODE>-method in <CODE>PdfArray</CODE> in order to prevent the adding
     * of extra object to the array.
     *
