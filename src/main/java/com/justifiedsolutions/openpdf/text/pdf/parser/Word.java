...
public class Word extends ParsedTextImpl {
    ...
    Word(String text, float ascent, float descent, Vector startPoint,
            Vector endPoint, Vector baseline, float spaceWidth, boolean isCompleteWord,
            boolean breakBefore) {
     ...
     * @see ParsedTextImpl#accumulate(TextAssembler,
     * String)
     ...
     * @see ParsedTextImpl#assemble(TextAssembler)
     */
    @Override
    ...
    /**
     * Generate markup for this word. send the assembler a strings representing a CSS style that
     * will format us nicely.
     *
     * @param text      passed in because we may have wanted to alter it, e.g. by trimming white
     *                  space, or filtering characters or something.
